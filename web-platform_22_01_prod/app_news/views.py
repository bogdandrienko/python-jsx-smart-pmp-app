...
def news_list(request):
    ...
    return render(request, 'app_news/list.html', {'latest_article_list': latest_article_list})
...
def news_create(request):
    ...
    return render(request, 'app_news/create.html', {'post_form': post_form})
...
def news_detail(request, article_id):
    ...
    return render(request, 'app_news/detail.html', {'article': a, 'latest_comments_list': latest_comments_list})
