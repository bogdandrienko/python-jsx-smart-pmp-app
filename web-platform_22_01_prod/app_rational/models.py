...
class RationalModel(models.Model):
    ...
    rational_date_registrated = models.DateTimeField('дата регистрации', editable=True, auto_created=True,
    ...
    rational_autor_name = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, editable=True, default=None,
    ...
    def __str__(self):
        return f'{self.rational_name} :: {self.rational_uid_registrated} :: {self.rational_category} :: ' \
               f'{self.rational_autor_name}'
