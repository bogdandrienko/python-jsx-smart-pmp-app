              ...
              <li key={index} className="m-1">
                <div className="card shadow-sm">
                    <div className="card-header">
                        <a className="text-decoration-none lead text-dark" href="#">
                    ...
                    <div className="card-header">
                        <form action="#" method="POST" className="m-1">
                            <label className="form-control-lg">
                                ...
                                />
                                <small className="text-muted">! функционал модератора !</small>
                            </label>
                            <button className="btn btn-sm btn-outline-danger" type="submit">скрыть</button>
                        </form>
                        <form action="#" method="POST" className="m-1">
                            <label className="form-control-lg">
                                Одобрить идею:
                            ...
                            <button className="btn btn-sm btn-outline-success" type="submit">одобрить</button>
                        </form>
                        <div className="form-control-lg m-1">
                            Редактировать идею:
                            <a className="btn btn-sm btn-outline-warning" target="_blank" href="#">Редактировать</a>
                        </div>
                        <div className="container-fluid d-flex justify-content-between">
                                <a className="btn btn-sm btn-outline-success m-1" href="#">
                                    Автор: {rational.user_model.last_name_char_field} { rational.user_model.first_name_char_field } {rational.user_model.patronymic_char_field}
                                </a>
                            <a className="btn btn-sm btn-outline-secondary" href="#">{ rational.category_char_field }</a>
                        </div>
                    </div>
                    <div className="card-body">
                        <div className="container-fluid m-1">
                            <a href="#">
                                <img src={getStaticFile(rational["avatar_image_field"])} className="card-img-top img-fluid" alt="id" />
                            </a>
                        </div>
                        <div className="container-fluid m-1">
                            <small className="text-muted">{rational["short_description_char_field"]}</small>
                        </div>
                        <div className="container-fluid d-flex justify-content-between m-1">
                            <small className="text-muted">подано: {getCleanDateTime(rational["created_datetime_field"])}</small>
                            <small className="text-muted">зарегистрировано: {getCleanDateTime(rational["register_datetime_field"])}</small>
                        </div>
                        <div className="container-fluid btn-group">
                            <a className="btn btn-sm btn-outline-primary m-1" href="#">Подробнее</a>
                            <form className="m-1" action="#" method="POST">
                                ...
                                <input type="text"
                                    ...
                                    className="form-control form-control-lg d-none"
                                />
                                <button className="btn btn-sm btn-outline-danger" type="submit">Пожаловаться на идею</button>
                            </form>
                        </div>
                    </div>
                    <div className="card-header">
                        <ul className="container-fluid col-auto col-md-auto col-lg-auto justify-content-center">
                            ...
                            <li className="m-1">
                                <a href="#" className="text-decoration-none">
                                    <small className="text-success">Вам понравилось</small>
                                    <small className="text-danger">Вам не понравилось</small>
                                    <small className="text-secondary">Вы не оценили</small>
                                </a>
                            </li>
                            <li className="m-1">
                                <a href="#">
                                    <div className="btn btn-sm btn-outline-secondary">Комментариев: { rational.get_total_comment_value }</div>
                                </a>
                            </li>
                        </ul>
                    </div>
