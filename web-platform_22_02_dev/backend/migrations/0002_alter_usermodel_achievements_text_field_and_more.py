# Generated by Django 4.0 on 2022-02-04 15:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='usermodel',
            name='activity_boolean_field',
            field=models.BooleanField(blank=True, db_column='activity_boolean_field_db_column', db_index=True, db_tablespace='activity_boolean_field_db_tablespace', default=True, error_messages=False, help_text='<small class="text-muted">activity_boolean_field</small><hr><br>', verbose_name='Активность аккаунта пользователя'),
        ),
        migrations.AlterField(
            model_name='usermodel',
        ...
        migrations.AlterField(
            ...
            field=models.SlugField(blank=True, db_column='password_slug_field_db_column', db_tablespace='password_slug_field_db_tablespace', default='', error_messages=False, help_text='<small class="text-muted">password_slug_field</small><hr><br>', max_length=16, null=True, validators=[django.core.validators.MinLengthValidator(8), django.core.validators.MaxLengthValidator(16)], verbose_name='Пароль от аккаунта пользователя'),
        ),
        migrations.AlterField(
            model_name='usermodel',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, db_column='secret_answer_char_field_db_column', db_index=True, db_tablespace='secret_answer_char_field_db_tablespace', default='', error_messages=False, help_text='<small class="text-muted">secret_answer_char_field</small><hr><br>', max_length=16, null=True, validators=[django.core.validators.MinLengthValidator(0), django.core.validators.MaxLengthValidator(16)], verbose_name='Секретный ответ'),
        ),
        migrations.AlterField(
            model_name='usermodel',
