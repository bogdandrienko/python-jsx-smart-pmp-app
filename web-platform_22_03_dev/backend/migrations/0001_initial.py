    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sphere_char_field', models.CharField(blank=True, db_column='sphere_char_field_db_column', db_index=True, db_tablespace='sphere_char_field_db_tablespace', default='', error_messages=False, help_text='<small class="text-muted">sphere_char_field</small><hr><br>', max_length=128, null=True, validators=[django.core.validators.MinLengthValidator(0), django.core.validators.MaxLengthValidator(128)], verbose_name='Сфера рац. предложения')),
                ('category_char_field', models.CharField(blank=True, db_column='category_char_field_db_column', db_index=True, db_tablespace='category_char_field_db_tablespace', default='', error_messages=False, help_text='<small class="text-muted">category_char_field</small><hr><br>', max_length=128, null=True, validators=[django.core.validators.MinLengthValidator(0), django.core.validators.MaxLengthValidator(128)], verbose_name='Категория')),
                ...
                ('place_char_field', models.CharField(blank=True, db_column='place_char_field_db_column', db_index=True, db_tablespace='place_char_field_db_tablespace', default='', error_messages=False, help_text='<small class="text-muted">place_char_field</small><hr><br>', max_length=128, null=True, validators=[django.core.validators.MinLengthValidator(0), django.core.validators.MaxLengthValidator(128)], verbose_name='Предполагаемое место внедрения')),
                ...
                ('additional_pdf_file_field', models.FileField(blank=True, db_column='additional_pdf_file_field_db_column', db_index=True, db_tablespace='additional_pdf_file_field_db_tablespace', default=None, error_messages=False, help_text='<small class="text-muted">additional_pdf_file_field</small><hr><br>', max_length=200, null=True, upload_to='uploads/idea/files/', validators=[django.core.validators.FileExtensionValidator(['pdf'])], verbose_name='Pdf файл-приложение')),
                ...
                ('user2_char_field', models.CharField(blank=True, db_column='user2_char_field_db_column', db_index=True, db_tablespace='user2_char_field_db_tablespace', default='', error_messages=False, help_text='<small class="text-muted">user2_char_field</small><hr><br>', max_length=256, null=True, validators=[django.core.validators.MinLengthValidator(0), django.core.validators.MaxLengthValidator(256)], verbose_name='user2')),
                ...
                ('user4_char_field', models.CharField(blank=True, db_column='user4_char_field_db_column', db_index=True, db_tablespace='user4_char_field_db_tablespace', default='', error_messages=False, help_text='<small class="text-muted">user4_char_field</small><hr><br>', max_length=256, null=True, validators=[django.core.validators.MinLengthValidator(0), django.core.validators.MaxLengthValidator(256)], verbose_name='user4')),
                ('user5_char_field', models.CharField(blank=True, db_column='user5_char_field_db_column', db_index=True, db_tablespace='user5_char_field_db_tablespace', default='', error_messages=False, help_text='<small class="text-muted">user5_char_field</small><hr><br>', max_length=256, null=True, validators=[django.core.validators.MinLengthValidator(0), django.core.validators.MaxLengthValidator(256)], verbose_name='user5')),
