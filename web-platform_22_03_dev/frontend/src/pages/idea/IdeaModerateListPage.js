                    ...
                    <div className="card shadow text-center p-0">
                      <div className="card-header">
                        <label className="lead">
                          Выберите нужные настройки фильтрации и сортировки,
                          ...
                          {utils.CheckAccess(
                            ...
                            <label className="form-control-sm">
                              ...
                              >
                                ...
                                <option value="на модерации">
                                  на модерации
                                </option>
                                <option value="на доработку">
                                  на доработку
                                </option>
