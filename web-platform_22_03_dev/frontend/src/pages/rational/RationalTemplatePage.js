              ...
              <div className="m-0 p-0">
                <label className="form-control-sm text-center m-0 p-1">
                  ...
                  <a
                    ...
                    href={utils.GetStaticFile(
                      `/media/default/rational/тренажер.docx`
                    )}
                  >
                    Скачать документ
                  </a>
                ...
                <label className="form-control-sm text-center m-0 p-1">
                  ...
                  <a
                    ...
                    href={utils.GetStaticFile(
                      `/media/default/rational/тренажер.pdf`
                    )}
                  >
                    Скачать документ
                  </a>
                ...
                <label className="form-control-sm text-center m-0 p-1">
                  ...
                  <a
                    ...
                    href={utils.GetStaticFile(
                      `/media/default/rational/тренажер.xlsx`
                    )}
                  >
                    Скачать документ
                  </a>
                ...
                <li className="list-group-item m-0 p-1">
                  ...
                  <div className="d-flex justify-content-center m-0 p-1">
                    <small className="text-muted m-0 p-1">
                      Это очень полезное рационализаторское предложение!
                    </small>
                  </div>
                </li>
              </ul>
