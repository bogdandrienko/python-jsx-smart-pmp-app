...
import { vacancyDetailAction, vacancyRespondAction } from "../../js/actions";
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
const VacancyListPage = () => {
  ...
  const vacancyRespondStore = useSelector((state) => state.vacancyRespondStore); // store.js
  const {
    // load: loadVacancyRespond,
    data: dataVacancyRespond,
    // error: errorVacancyRespond,
    // fail: failVacancyRespond,
  } = vacancyRespondStore;
  ...
  useEffect(() => {
    if (dataVacancyRespond) {
      utils.Sleep(2000).then(() => {
        dispatch({ type: constants.VACANCY_RESPOND_RESET_CONSTANT });
  ...
  const formHandlerSubmit = (e) => {
    ...
    dispatch(actions.vacancyRespondAction(form));
  };
