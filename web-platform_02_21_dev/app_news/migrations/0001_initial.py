...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rating_name', models.CharField(max_length=50, verbose_name='имя рейтинга')),
                ('rating_value', models.IntegerField(verbose_name='рейтинг')),
                ('rating_article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_news.article')),
            ],
            options={
