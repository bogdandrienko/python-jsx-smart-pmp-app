...
class DirFolderPathClass:
    @staticmethod
    def create_folder_in_this_dir(folder_name='folder', current_path=os.path.dirname(os.path.abspath('__file__'))):
