...
class ConsoleTimerClass:
    ...
    def example():
        ...
        def render(sec, minut, hour):
            print(colorama.Fore.GREEN + str(hour), colorama.Fore.WHITE + ":", colorama.Fore.BLUE + str(minut),
                  colorama.Fore.WHITE + ":", colorama.Fore.RED + str(sec), file=stream)
