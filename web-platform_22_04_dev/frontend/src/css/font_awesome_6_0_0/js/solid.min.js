...
!(function () {
  ...
  function H(c, C) {
    ...
    return (
      Object.getOwnPropertySymbols &&
        ((l = Object.getOwnPropertySymbols(c)),
        C &&
  ...
  function V(z) {
    for (var C = 1; C < arguments.length; C++) {
      ...
      C % 2
        ? H(Object(M), !0).forEach(function (C) {
            var c, l;
            (c = z),
              (C = M[(l = C)]),
              l in c
        ...
        ? Object.defineProperties(z, Object.getOwnPropertyDescriptors(M))
        : H(Object(M)).forEach(function (C) {
  ...
  function t(C, c, l) {
    ...
    "function" != typeof f.hooks.addPack || l
      ? (f.styles[C] = V(V({}, f.styles[C] || {}), z))
      : f.hooks.addPack(C, v(c)),
      "fas" === C && t("fa", c);
  }
  var o = {
    0: [
  ...
  !(function (C) {
    try {
      for (
        var c = arguments.length, l = new Array(1 < c ? c - 1 : 0), z = 1;
        z < c;
        z++
      )
        l[z - 1] = arguments[z];
