...
var captcha = require("../../components/ui/captcha");
// TODO export /////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (captchaCheckStore.data) {
                    dispatch(action.User.UserLoginAction(constant.userLoginStore, user.username, user.password));
                }
                return [2 /*return*/];
            });
        });
        ...
        <form className="m-0 p-0" onSubmit={Login}>
          <div className="card shadow custom-background-transparent-low m-0 p-0">
            ...
            <div className="card-body m-0 p-0">
              <div className="m-0 p-1">
                <label className="form-control-sm text-center w-75 m-0 p-1">
                  ...
                  Введите Ваш ИИН:
                  <input type="text" className="form-control form-control-sm text-center m-0 p-1" value={user.username} placeholder="введите ИИН тут..." required minLength={12} maxLength={12} onChange={function (event) {
            return setUser(__assign(__assign({}, user), { username: event.target.value.replace(util.GetRegexType({
                    numbers: true,
                }), "") }));
                ...
                <label className="form-control-sm text-center w-75 m-0 p-1">
                  ...
                  <div className="input-group form-control-sm m-0 p-1">
                    <input type="password" className="form-control form-control-sm text-center m-0 p-1" id="password" value={user.password} placeholder="введите пароль тут..." required onChange={function (event) {
            return setUser(__assign(__assign({}, user), { password: event.target.value.replace(util.GetRegexType({
                    numbers: true,
                    latin: true,
                    lowerSpace: true,
                }), "") }));
        }} autoComplete="current-password" minLength={8} maxLength={16}/>
                    <span className="">
            ...
            <div className="card-footer m-0 p-0">
              <component.StoreComponent storeStatus={constant.userLoginStore} consoleLog={constant.DEBUG_CONSTANT} showLoad={true} loadText={""} showData={true} dataText={""} showError={true} errorText={""} showFail={true} failText={""}/>
              ...
              <ul className="btn-group row nav row-cols-auto row-cols-md-auto row-cols-lg-auto justify-content-center m-0 p-0">
                <react_router_dom_1.Link to="/recover_password" className="btn btn-sm btn-success m-1 p-2">
