    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_visible', models.BooleanField(blank=True, db_column='is_visible_db_column', db_index=True, db_tablespace='is_visible_db_tablespace', default=False, error_messages=False, help_text='<small class="text-muted">is_visible</small><hr><br>', unique_for_date=False, unique_for_month=False, unique_for_year=False, verbose_name='Видимость идеи в общем списке')),
