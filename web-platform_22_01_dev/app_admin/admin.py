...
from app_admin.models import ExamplesModel, LoggingModel, ModulesModel, GroupModel, NotificationModel, ActionModel, \
    UserModel
...
admin.site.register(ModulesModel, ModulesModelAdmin)
