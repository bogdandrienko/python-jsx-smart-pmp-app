    ...
    class FieldsClass:
        class ExtraClass:
            ...
            field = models.Field(
                ...
                editable=True,
                # If False, the field will not be displayed in the admin or any app_django ModelForm. They are also
        ...
        class SlugFieldClass:
            ...
            # automatically prepopulate a SlugField based on the value of some app_django value. You can do this
        ...
        class DateTimeFieldClass:
            ...
            datetime_field = models.DateTimeField(
                ...
                # making updates to app_django fields in app_django ways such as QuerySet.update(), though you can specify
