...
class MainWidgetclass(QtWidgets.QWidget):
    def __init__(self, title="APP", width=640, height=480, icon="", play_f=None, stop_f=None, quit_f=None,
        ...
        self.sql_write = AppContainerClass.create_qcheckbox(self.h_layout_sql_1, 'WRITE TO SQL?', default=False)
        ...
        self.autoplay_check = AppContainerClass.create_qcheckbox(self.h_layout_debug_1, 'AUTOPLAY?', default=False)
        ...
        self.h_layout_debug_2.addStretch(0)
        self.widget_write = AppContainerClass.create_qcheckbox(self.h_layout_debug_2, 'WRITE TO WIDGET?', default=False)
        ...
        self.resolution_debug_2 = AppContainerClass.create_qradiobutton(self.h_layout_debug_3, '640x480', default=False)
